...
export function PhoneNumberScreen() {
  ...
  return (
    <Screen pad="8px 24px 24px">
      ...
      <div style={{ height: 20 }} />
      <button type="button" className="btn btn-xl btn-primary" style={{ width: '100%' }} onClick={() => go('otp')}>
        {t.send_code}
      </button>
    </Screen>
  )
...
export function OtpScreen() {
  const { t, otp, otpError, set, pressKey } = usePhone()
      ...
      <div style={{ minHeight: 46, marginTop: 13 }}>
        {otpError ? (
          ...
          >
            ...
            <div style={{ fontSize: 13.5, lineHeight: 1.45, color: C.clayInk }}>{t.wrong_code}</div>
          </div>
        ) : (
          <div
            style={{
...
export function BiometricScreen() {
  ...
  return (
    <Screen pad="8px 24px 28px">
      ...
      <button type="button" className="btn btn-xl btn-primary" style={{ width: '100%' }} onClick={() => go('sponsor')}>
        {t.bio_on}
      </button>
      <button
        type="button"
